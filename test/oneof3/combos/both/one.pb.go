...
func (m *SampleOneOf) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SampleOneOf_Field1) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 8
...
func (m *SampleOneOf_Field2) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 4
...
func (m *SampleOneOf_Field3) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *SampleOneOf_Field4) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *SampleOneOf_Field5) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *SampleOneOf_Field6) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *SampleOneOf_Field7) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *SampleOneOf_Field8) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *SampleOneOf_Field9) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 4
...
func (m *SampleOneOf_Field10) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 4
...
func (m *SampleOneOf_Field11) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 8
...
func (m *SampleOneOf_Field12) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 8
...
func (m *SampleOneOf_Field13) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Field13 {
		dAtA[i] = 1
...
func (m *SampleOneOf_Field14) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Field14)
...
func (m *SampleOneOf_Field15) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Field15 != nil {
		i -= len(m.Field15)
...
func (m *SampleOneOf_SubMessage) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SubMessage != nil {
		{

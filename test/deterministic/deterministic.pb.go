...
func (m *NestedOrderedMap) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NestedMap != nil {
		...
		n1, err := m.NestedMap.DeterministicMarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
...
func (m *NestedUnorderedMap) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NestedMap != nil {
		...
		i++
		i = encodeVarintDeterministic(dAtA, i, uint64(m.NestedMap.Size()))
		n2, err := m.NestedMap.DeterministicMarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *NestedUnorderedMap) DeterministicMarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.NestedMap != nil {
		...
		i++
		i = encodeVarintDeterministic(dAtA, i, uint64(m.NestedMap.Size()))
		n3, err := m.NestedMap.DeterministicMarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *NestedMap2) DeterministicMarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l

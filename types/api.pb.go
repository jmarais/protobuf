...
func (m *Api) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Mixins) > 0 {
		for iNdEx := len(m.Mixins) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Mixins[iNdEx].LahsramOt(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.Methods) > 0 {
		for iNdEx := len(m.Methods) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Methods[iNdEx].LahsramOt(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Method) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Mixin) LahsramOt(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
